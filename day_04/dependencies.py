...
def get_pagination(
    ...
    return PaginationParam(limit, offset)
...
class CurrentUser:
    ...
    #     return f"CurrentUser(id={self.user_id}, name='{self.name}', role='{self.role}')"
...
class BookFilters:
    def __init__(
        ...
        min_year: Optional[str] = Query(default=None, ge=1, description="Minimum publication year"),
        max_year: Optional[str] = Query(default=None, ge=1, description="Maximum publication year")
    ):
        self.author = author
...
def get_book_filters(
    ...
    return BookFilters(author, min_year, max_year)

# # ---------------------------------------------------------------
# # 5. REQUEST VALIDATION DEPENDENCY
# #
# # Validates request bodies before they reach the handler.
# # ---------------------------------------------------------------
...
# def validate_book_create(book: BookCreate) -> BookCreate:
#     """
#     Validates the book creation request body.
#     """
#     return book

# def validate_book_update(book: BookUpdate) -> BookUpdate:
#     """
#     Validates the book update request body.
#     """
#     return book
